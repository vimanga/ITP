...
<% 
	...
	<div class="container-fluid" style="height: 2000px">
		...
		<div>
	     ...
	     <form:form method="POST" modelAttribute="client"  class="form-horizontal" action="savebranch" id="validation2">
				...
				<label class="control-label col-sm-2" for="clientID">Client ID</label>
  				...
  				<div class="form-group row" style="margin-left: 20%;margin-top: 3%">
    				<label class="control-label col-sm-2" for="bAddress">Branch Address<span class="glyphicon glyphicon-star"></span></label>
    					<div class="col-sm-4">
  				...
  				<div class="form-group row"  style="margin-left: 20%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="bCity">Branch City<span class="glyphicon glyphicon-star"></span></label>
    					<div class="col-sm-4"> 
						...
						fields: 
						{
							...
							bAddress: 
							{
								validators: 
								{
									...
									{
										min: 5,
										message: 'Enter Branch Address with minimum 5 letters length'
									},
									notEmpty: 
									{
									...
									{
			                          regexp: /^[a-zA-Z0-9 ,]+$/,
			                          message: 'The Branch Address can only consist of alphabetical'
									}
								}
							...
							bCity: 
							{
								validators: 
								{
									...
									{
										min: 5,
										message: 'Enter Branch city with minimum 5 letters length'
									},
									notEmpty: 
									{
										message: 'Enter Branch City'
									},
									
									regexp: 
									{
			                          regexp: /^[a-zA-Z ]+$/,
			                          message: 'The Branch City can only consist of alphabetical'
			                        }
