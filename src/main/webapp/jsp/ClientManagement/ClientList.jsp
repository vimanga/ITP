...
<% 
	...
	<div class="container-fluid" style="height: 2000px">
		<div class="row" >
	     ...
	     <h1 class="text-center" style="margin-top:4%">Client List</h1>
	    
		  <form:form style="margine-top:5%">
		     <div>
		     
		        <table id="t01" border="2px" align="center">
		            ...
		            <c:forEach var="client" items="${list}">
		              ...
		              <tr align="center" width="80%">
		               ...
		               <td >
		                 <a href="/deleteclient?clientID=${client.clientID}" onclick="return confirm('Are you sure you want to remove the client')">DELETE</a>  
		               </td>
		               <td>
		                 <a href="/editClient?clientID=${client.clientID}" onclick="return confirm('Are you sure you want to edit the client details')">EDIT</a>
		               </td>
		               <td>
		                 <a href="/cprofile?clientID=${client.clientID }">PROFILE</a>
		               </td>
		            </c:forEach>
		        </table>
