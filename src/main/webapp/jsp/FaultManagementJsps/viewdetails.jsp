		...
		<div class="table-responsive">
			<table id="t01" class="table table-striped table-bordered">
   			...
   			<tr>  
				...
				<td>
				<c:choose>
    						<c:when test="${fault.isassigned}"><a href="/servicall/${fault.id}" class="com"><span class="glyphicon glyphicon-check"></span></a></c:when>
    						<c:otherwise>Assign Technician</c:otherwise>
    					</c:choose>
				</td>
   			</tr>  
