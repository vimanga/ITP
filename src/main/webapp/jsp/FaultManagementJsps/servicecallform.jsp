...
<body>
	...
	<br><br>
		...
		<div class="row md-auto">
			<div class="col-md-12">
					<form:form  method ="POST" modelAttribute="sc" id="validateForm8" class="form-horizontal form-responsive" action = "/addto">
    					...
    					<div class="form-group row" style="margin-left: 30%;margin-top: 4%">
    					<label class="control-label col-sm-2" for="custoID">Client ID</label>
    					<div class="col-sm-4">
    					      						CLI${sc.custoID} 
    					...
    					<div class="col-sm-4">
  							<div class="form-check">
  								<label class="form-check-label">
    								<input type="radio" class="form-check-input" checked="checked" path="fullyFunc" name="fullyFunc" value="1"/>Yes
 								</label>
							</div>
							<div class="form-check">
  								<label class="form-check-label">
  		...
  		$(function(){
  		    ...
  		    $('#datet').attr('min', minDate);
				...
				$('#validateForm8').bootstrapValidator({
					feedbackIcons: {
