...
<body>
	...
	<div class="container-fluid" style="height: 2000px">
		...
		<div class="row mx-auto">
			<div class="col-md-12">
								<h2 align="center" style="margin-top: 2%">Supplier Order</h2>
			
				<form:form method="POST" class="form-horizontal" id="validateForm2" action="submit1">
  		<!-- 		<div class="form-group row" style="margin-left: 30%;margin-top: 12%">
    				<label class="control-label col-sm-2" for="email">Supplier ID</label>
    					<div class="col-sm-4">
      						<input type="text" name="id" class="form-control" id="id" placeholder="Enter Client ID" data-validation="number">
    					</div>
 	 			</div>		 -->
 	 			
 	 			<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="id">Supplier</label>
    					<div class="col-sm-4"> 
      					...
      					<!--		<option value=-1>Credit card</option>	-->
      							...
      							try
					    		{
					    			String query ="select supplierID, suppName from supplier";
					    			...
					    			while(rs.next()){
					    				...
					    				%><option value="<%=rs.getString("supplierID")%>"><%=rs.getString("suppName") %></option>
					    				<% 	    				
					    			}
  			...
  			-->	
  				...
  				<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="pwd">Delivery type</label>
    					<div class="col-sm-4"> 
      						<input name="deltyp" type="text" class="form-control" id="deltyp" placeholder="Enter discription">
    					</div>
  				</div>
  				<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
