	...
	<div class="container-fluid" style="height: 2000px">
		...
		<div class="row mx-auto">
			<div class="col-md-12">
				...
				<form:form method="POST" id="validateForm2" class="form-horizontal" action="suppliersubmit">
  				...
  				<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="pwd">Device</label>
    					<div class="col-sm-4"> 
      						<input type="text" name="item" class="form-control" id="item" placeholder="Enter Device">
    					</div>
  				</div>
  				
  				<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="regDate">Date Registered</label>
    					<div class="col-sm-4"> 
      						<input type="date" name="regDate" class="form-control" id="regDate" placeholder="Enter date">
    					</div>
  				</div>
