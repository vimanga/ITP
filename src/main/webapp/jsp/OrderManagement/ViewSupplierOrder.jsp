...
<body>
	...
	<div class="container-fluid" style="height: 2000px">
		<div class="row" >
			...
			<h2 align="center" style="margin-top: 2%">Supplier Orders</h2>
				<table id="t01" class="table table-striped table-bordered">
					<tr><th>OrderID</th><th>ClientID</th><th>Item</th><th>Quantity</th>
					<th>Expected date</th><th>Payment type</th><th>Delivery type</th><th>Description</th><th>Payments</th>
					...
					<tr>
						...
						<td> ${employee.date}</td>
						<td> ${employee.paytyp}</td>
						<td> ${employee.deltyp}</td>
						<td> ${employee.description}</td>
						<td>
							<c:choose>
								<c:when test="${employee.proceed_payment}"><a href="#">confirmed</a></c:when>
								<c:otherwise><a href="/proceedsupPayments/${employee.sid}">Proceed to payments</a></c:otherwise>
												</c:choose>
						
							</td>
						<td><a href="/EditSupplierOrder?id=${employee.sid}">Edit</a></td>
						<td><a href="/supOrderDelete?id=${employee.sid}" onclick="return confirm('Are you sure you want to delete order');">Delete</a></td>
					</tr>
				</c:forEach>
