...
<head>
	...
	<script src="js/EmployeeManagement/AutoGenerate.js"></script>
				...
				<img src="Images/logo.png" style="width:12%;margin-left: 2%">
 				...
 				<a href="signout"><font style="font-family: Good Times; font-size: 100%"><span style="color: white;margin-left: 90%;">Sign Out</span></font></a>
 					<div class="navbar">
						...
						<div class="dropdown">
   							<button class="dropbtn dropdown-toggle"><a href="orderdashboard" style="color: black;text-decoration: none;">Order Management</a></button>
						  	<div class="dropdown-content">
			...
			<div class="form-container">
				...
				<div class="row">
  				...
  				<div class="row">
	    			...
	    			<div class="col md-5 mt-5 ">
	      					<button onclick="generate()" class="btn btn-primary">Auto Generate</button>
	    			</div>
      			</div>
				</form:form>
			</div>
