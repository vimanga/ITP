<%@page import="com.example.demo.controller.EmployeeManagement.DashboardControllerEmployee"%>
   ...
   <br/>
			...
			new Chart(document.getElementById("pie-chart"), 
			{
    			...
    			data: 
    			{
      				...
      				[
        			{
				        ...
				        data: [<%=DashboardControllerEmployee.chartX()%>,<%=DashboardControllerEmployee.chartY()%>,<%=DashboardControllerEmployee.chartZ()%>]
        			}
      				]
    			},
		...
		new Chart(document.getElementById("pie-chartGender"), 
		{
    		...
    		data: 
    		{
      			...
      			[
        		{
		          ...
		          data: [<%=DashboardControllerEmployee.chartA()%>,<%=DashboardControllerEmployee.chartB()%>]
        		}
      			]
    		},
    		options: 
		...
		var chartData = {
	      	...
	      	[
	        {
	          	...
	          	data: [<%=DashboardControllerEmployee.chartC()%>,<%=DashboardControllerEmployee.chartD()%>,<%=DashboardControllerEmployee.chartE()%>,<%=DashboardControllerEmployee.chartF()%>]
	        }
	      ]		
		};
