...
<body>
	...
	<br><br>
		...
		<div class="row md-auto">
			<div class="col-md-12">
				<form:form  method ="POST" modelAttribute="device" id="validateForm1" class="form-horizontal form-responsive" action = "register">
 	 			...
 	 			<div class="form-group row" style="margin-left: 30%;margin-top: 2%">
    				<label class="control-label col-sm-2" for="supplierID">SupplierID</label>
    					<div class="col-sm-4">
    						<select style ="width: 280px; height: 35px; padding: 8px;" id="supplierID" path="supplierID" name="supplierID">
    						<option value=""></option>
    						<%
    							try{
    								String sql = "select supplierID, suppName from supplier ";
    								...
    								while (rs.next()){
    									...
    									<option value = "<%= rs.getInt("supplierID") %>"> <%= rs.getString("suppName") %></option>
    									<%
    								}
    							}
    						...
    						%>
      						...
      						<div class = "has-error">
      						<form:errors path="supplierID" class="help-inline"/>
      						</div>
    					</div>
 	 			</div>
