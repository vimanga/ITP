					...
					<div class="row" style="margin-left: 42%;width:38%;">
						...
						<c:choose>
							...
							<c:when test="${employeeCode='null'} ">
								<input type="submit" value="Add Technician" class="btn btn-primary btn-sm"/>
							</c:when>
							<c:otherwise>
								<input type="submit" value="Add Technician" class="btn btn-primary btn-sm" disabled="disabled"/>
							</c:otherwise>						
