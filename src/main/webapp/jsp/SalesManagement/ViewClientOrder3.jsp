...
<body>
	...
	<div class="container-fluid" style="height: 2000px">
		...
		<h2 align="center">Orders From  :   ${range.range_1}   &nbsp &nbsp  To  :   ${range.range_2}</h2>
		<br>
		
		<c:set var="range_1" value="${range.range_1}" scope="session"/>
		<c:set var="range_2" value="${range.range_2}" scope="session"/>
				<div class="row" style="margin-left: 80%;align:right;" >
      					<button type="reset" class="btn btn-primary" style="width: 210px" onclick="window.open('ordersforrangepdf')">Generate Orders Report</button>
    			</div>
      	
		<br>
		
			<div class="table-responsive">
<form:form style="overflow-x:hidden">
