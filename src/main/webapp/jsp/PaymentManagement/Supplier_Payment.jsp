			...
			<div class="row mx-auto">
				<div class="col-md-12">
					...
					<div class="col-md-12  my-5 text-center">
						<span style="text-decoration: underline;"><h4>Supplier
								Payments</h4></span>
					</div>


					<form:form modelAttribute="supplierPayments"
						class="form-horizontal" action="/supplierPaySave" method="POST"
						id="validateForm1">
						...
						<div class="form-group row"
							style="margin-left: 30%; margin-top: 4%">
							<label class="control-label col-sm-2" for="supOrderID"></label>
							<div class="col-sm-4">
								<form:input type="hidden" path="supOrderID" class="form-control"
									id="supOrderID" placeholder="s" name="supOrderID" />
								<div class="has-error">
									<form:errors path="supOrderID" class="help-in-line" />
								</div>
							</div>
						</div>
						...
						<div class="form-group row"
							style="margin-left: 30%; margin-top: 4%">
							<label class="control-label col-sm-2" for="supName">Customer
								Name</label>
							<div class="col-sm-4">
								<form:input type="text" path="supName" class="form-control"
									id="supName" placeholder="Name" name="supName" />
								<div class="has-error">
									<form:errors path="supName" class="help-in-line" />
								</div>
							</div>
						</div>
						...
						<div class="form-group row"
							...
							<div class="col-sm-4">
								...
								<div class="has-error">
									<form:errors path="Email" class="help-in-line" />
								</div>
							</div>
						</div>
