	...
	<div class="container-fluid" style="height: 2000px">
		...
		<div class="form-group row">
			<div class="col md-6 offset-4 mt-5 ">
				<a href="Find_By_Status"><button type="submit"
						class="btn btn-primary">Petty Cash Register</button></a>
			</div>
		</div>
		<div class="form-group row">
			<div class="col md-6 offset-4 mt-5 ">
				<a href="Petty_Cash_Issue"><button type="reset"
						class="btn btn-primary">Issue Petty Cash</button></a>
			</div>
		</div>
		<div class="form-group row">
			<div class="col md-6 offset-4 mt-5 ">
				<a href="Find_By_Status_Pending"><button type="submit"
						class="btn btn-primary">Pending Status</button></a>
			</div>
		</div>
		<div class="form-group row">
			<div class="col md-6 offset-4 mt-5">
				<a href="/pettyCashDashboard"><button type="submit"
						class="btn btn-primary">Petty Cash Dashboard</button></a>
			</div>
		</div>
