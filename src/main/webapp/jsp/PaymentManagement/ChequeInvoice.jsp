...
<%@page import="com.example.demo.model.PaymentManagement.ClientChequePayments"%>
...
<%@page import="java.sql.Connection"%>
	...
	<% Connection con=null;  
	 	...
	 	String jrxmlFile = session.getServletContext().getRealPath("/jsp/PaymentManagement/ChequeInvoice.jrxml");
		int k = (Integer) session.getAttribute("id");
	 	JasperDesign jd= JRXmlLoader.load(new File(jrxmlFile));
		JRDesignQuery newQuery = new JRDesignQuery();
	 	newQuery.setText("select * from clientchequepayments where salesID="+k);
	 	System.out.println("========================================");
	 	System.out.println("=========================================");
