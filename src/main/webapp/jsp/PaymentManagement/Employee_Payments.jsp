...
<body>
	...
	<div class="container-fluid" style="height: 2000px">
		...
		<div class="row mx-auto">
			...
			<div class="col-md-12  my-5 text-center"><span style="text-decoration: underline;"><h4>Employee Payments</h4></span></div>
				...
				<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="pwd">Employee Pay Id</label>
    					<div class="col-sm-4"> 
				...
				<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="pwd"> Basic Salary</label>
    					<div class="col-sm-4"> 
      						<input type="password" class="form-control" id="pwd" placeholder="Customer Name">
    					</div>
  				</div>
    				...
    				<label class="control-label col-sm-2" for="pwd"> Bonus</label>
    					<div class="col-sm-4"> 
      						<input type="password" class="form-control" id="pwd" placeholder="Bonus">
    					</div>
  				</div>
					
					<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="pwd"> EPF/ETF</label>
    					<div class="col-sm-4"> 
      						<input type="password" class="form-control" id="pwd" placeholder="EPF/ETF">
    					</div>
  				</div>
				<div class="form-group row"  style="margin-left: 30%;margin-top: 4%">
    				<label class="control-label col-sm-2" for="pwd"> Remarks</label>
    					<div class="col-sm-4"> 
      						<input type="password" class="form-control" id="pwd" placeholder="Remarks">
    					</div>
  				</div>
