...
<%@page import="com.example.demo.model.PaymentManagement.SupplierPayment"%>
...
<%@page import="java.sql.Connection"%>
	...
	<% Connection con=null;  
	 	...
	 	String jrxmlFile = session.getServletContext().getRealPath("/jsp/PaymentManagement/Supplier_Payments_Report.jrxml");
	
	 	JasperDesign jd= JRXmlLoader.load(new File(jrxmlFile));
		JRDesignQuery newQuery = new JRDesignQuery();
	 	newQuery.setText("select * from suppplierpayments");
