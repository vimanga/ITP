...
<table id="t01" border="2px" width="70%" cellpadding="2" class="table table-dark">
<tr><th>Id</th><th>Date</th><th>Amount</th>
<th>EmployeeId</th><th>Reason</th>
<th>Return Status</th></tr>  
   ...
   <td>${pettyCashRegister.returnStatus}</td> 
    <td><a href="pettyIssueEdit/${pettyCashRegister.pettyCashId}" onclick="return confirm('Are you Sure?');">Edit</a></td>  
