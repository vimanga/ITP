...
<body>
	...
	<div class="container-fluid" style="height: 2000px">
     ...
     <!--  <div class="col md-5 offset-3 mt-5 ">
      					<a href="/cashPayments"><button type="submit" class="btn btn-primary">Cash Payments</button></a>
    				</div>
    				
 	<div class="col md-5 mt-5 ">
      					<a href="/chequePayments"><button type="submit" class="btn btn-primary">Cheque Payments</button></a>
    				</div>-->
      
	<div class="col md-6 mt-5" style="margin-left:420px;" >
      					<a href="/allCashPayments"><button type="submit" class="btn btn-primary">All Payments</button></a>
    				</div>
      </div>
				
				 <div class="form-group row" style="margin-left:400px;">
		<div class="col md-6 mt-5 ">
      					<a href="/clientCashDashboard"><button type="submit" class="btn btn-primary">Payments Dashboard</button></a>
    				</div>
      </div>
