...
s				<div class="col-md-12">
					...
					<form:form method="POST" modelAttribute="pettyCashRegister"
						class="form-horizontal" action="/editsavepetty" id="validateForm1">
						<div class="form-group row"
							style="margin-left: 30%; margin-top: 4%">
							<label class="control-label col-sm-2" for="pettyCashId">
							Petty Cash ID      POP ${pettyCashRegister.pettyCashId}</label>
							<div class="col-sm-4">
								<form:input type="hidden" path="pettyCashId"
									class="form-control" id="pettyCashId" name="pettyCashId" />
								<div class="has-error">
									<form:errors path="pettyCashId" class="help-in-line" />
								</div>
							</div>
						</div>
						<div class="form-group row"
						...
						<div class="form-group row"
							...
							<div class="col-sm-4">
								<form:select path="returnStatus" class="form-control"
									id="returnStatus">
									<option value="${pettyCashRegister.returnStatus}" selected>${pettyCashRegister.returnStatus}</option>
						...
						<div class="form-group row">
							<div class="col md-6 offset-5 mt-6 ">
