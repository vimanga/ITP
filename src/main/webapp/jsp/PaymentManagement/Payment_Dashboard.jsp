<%@page
	import="com.example.demo.controller.PaymentManagement.PaymentDashboardController"%>
...
<body>
	...
	<div class="container-fluid" style="height: 2000px">
		...
		<div class="row" style="margin-top: 50px; height: 100px">
		...
		<div class="row" style="margin-top: 50px; height: 300px">
			<div class="col-md-5"
				style="background-color: rgba(255, 255, 255, 0.8); margin-left: 90px; border-radius: 30px">
			...
			<div class="col-md-5"
				style="background-color: margin-left: 90px; border-radius: 30px">
				...
				<!-- ----------------------------------- -->
      					...
      					<a href="/clientsPayments"><button type="submit" class="btn btn-primary">Client Payment</button></a>
    				
    				
 	
      					<a href="/employeePayments"><button type="sumbit" class="btn btn-primary">Employee Payment</button></a>
    				

	
    
      					<a href="/pettyCashRegister"><button type="submit" class="btn btn-primary">Office Payments</button></a>
    			
    				
 
      					<a href="/proceedToSupplierOrder"><button type="sumbit" class="btn btn-primary">Supplier Payments</button></a>
...
<script type="text/javascript">
			...
			new Chart(document.getElementById("pie-chart"), 
			{
    			...
    			data: 
    			{
      				...
      				[
        			{
          				label: "Total",
				        backgroundColor: ["#3e95cd", "#8e5ea2"],
				        data: [<%=PaymentDashboardController.chartX()%>,<%=PaymentDashboardController.chartY()%>]
        			}
      				]
    			},
		...
		<script type="text/javascript">
			var chartData = {
		      	...
		      	[
		        {
		          	label: "Total",
		          	backgroundColor: ["#3e95cd", "#8e5ea2"],
		          	data: [<%=PaymentDashboardController.chartA()%>,<%=PaymentDashboardController.chartB()%>]
		        }
		      ]		
			};
	...
	<footer class="page-footer" style="background-color: #5c5d60;">
		<div class="footer-copyright text-center py-3">Copyright © 2018
			Automated Barcode Solutions (Pvt) Ltd . All rights reserved</div>
	</footer>
