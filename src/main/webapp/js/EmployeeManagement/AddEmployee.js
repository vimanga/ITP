			...
			fields: 
			{
				...
				bankAccountNo: 
				{
					validators: 
					{
						...
						{
							regexp: /^[0-9]{10,}$/,
							message: 'Bank account no can only consist of numeric with minimum  10 numbers'
						}
				...
				contactNo1: 
				{
					validators: 
					{
						...
						{
						  regexp: /^[0-9]{10}$/,
                          message: 'The contact number can only consist of  10 numbers '
						}
					}
				},
				...
				basicSalary: 
				{
					validators: 
					{
						...
						{
                          regexp: /^[0-9]+$/,
                          message: 'The basic salary can only consist of  numerical'
						}
					}
				},
				...
				fields: 
				{
					...
					bikeNo: 
					{
						validators: 
						{
							...
							{
								min: 6,
								message: 'Enter Bike License field with minimum 6 letters of length '
							},
							notEmpty: 
							{
